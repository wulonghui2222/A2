...
import { A2_DEFAULT_MODEL, A2_PLATFORM_PROVIDER } from '~/a2/config';
...
// A2 (design D5): platform default model replaces upstream claude default.
export const DEFAULT_MODEL = A2_DEFAULT_MODEL;
...
// A2: default to the platform provider (OpenAILike -> Bailian); fall back to
// the first registered provider if missing.
export const DEFAULT_PROVIDER = llmManager.getProvider(A2_PLATFORM_PROVIDER) || llmManager.getDefaultProvider();
