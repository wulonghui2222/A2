...
import { A2_ENABLE_BYOK, A2_ENABLE_CODE_CONNECTIONS } from '~/a2/config';
...
export const SettingsWindow = ({ open, onClose }: SettingsProps) => {
  ...
  const tabs: { id: TabType; label: string; icon: string; component?: ReactElement }[] = [
    ...
    // A2 (design D6 / LG-04, task 6.1): BYOK entry and provider list are hidden
    // via constant switches; the tab components themselves are kept untouched.
    ...(A2_ENABLE_BYOK
      ? [{ id: 'providers' as TabType, label: 'Providers', icon: 'i-ph:key', component: <ProvidersTab /> }]
      : []),
    ...(A2_ENABLE_CODE_CONNECTIONS
